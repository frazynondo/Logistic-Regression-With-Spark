...
public class LogisticREG {
    ...
    public static void main(String[] args){
        ...
        Dataset<Row> rowDataset = dataSetFile(spark);

        Dataset<Row> dataS = FitTransformData(rowDataset);

        trainIT(FitTransformData(dataS));

    }

    public static Dataset<Row> dataSetFile(SparkSession spark) {
        Dataset<Row> csvData = spark.read()
                .option("header", true)
                .option("inferSchema", true)
                .csv("src/main/ResourceFiles/LogisticTestFiles/*.csv");
    ...
    public static Dataset<Row> FitTransformData(Dataset<Row> csvData) {
        ...
        public static void trainIT(Dataset<Row> csvData){
